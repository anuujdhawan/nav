...
import { Calendar, ArrowRight, Search, CheckCircle, Edit, Trash2 } from 'lucide-react';
...
export default function EditBlogClient({ posts: initialPosts }: { posts: BlogPost[] }) {
  ...
  const categories = ['All Categories', ...new Set([...initialPosts.map((post) => post.category), 'Other Blogs'])];
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {paginatedPosts.map((post) => (
                  <article key={post.id} className="bg-white border border-light-brown-grey rounded-xl overflow-hidden hover:shadow-lg transition-shadow relative">
                    <div className="absolute top-2 right-2 flex space-x-2 z-10">
                      <button
                        onClick={() => router.push(`/editblog/${post.id}`)}
                    ...
                    <div className="h-48 bg-gradient-to-br from-[#436175]/10 to-[#585a5e]/10 flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-[#436175] rounded-full flex items-center justify-center mx-auto mb-2">
                          <span className="text-white font-bold text-xl">N</span>
                        </div>
                        <p className="text-[#585a5e] text-sm">Navigator Immigration Consultant</p>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      ...
                      <h2 className="text-xl font-bold text-[#436175] mb-3">
                        {post.title}
                      </h2>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          onClick={() => router.push(`/editblog/${post.id}`)}
                          className="inline-flex items-center text-blue-600 hover:text-gray-600 font-medium text-sm"
                        >
                          Edit Post
              ...
              {totalPages > 1 && (
                <div className="mt-12 flex justify-center">
                  <nav className="flex flex-wrap justify-center gap-2" aria-label="Post pagination">
                    <button
